...
export function createClosure(d) {
  // Any known space, or "all" for the whole building. Derived from SPACES so a
  // new space's closures aren't silently widened into a building-wide closure.
  const space = d.space === "all" || SPACE_BY_ID[d.space] ? d.space : "all";
