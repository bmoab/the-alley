...
export const EVENT_CATEGORY = {
  ...
  upcoming_reminder_sent: "email",
  reschedule_sent: "email",
  reschedule_link_sent: "email",
  rescheduled: "action",
  ...
  listing_visibility_changed: "action",
  portal_announced: "email",
  tenant_events_announced: "email",
...
export const TYPE_LABELS = {
  ...
  listing_visibility_changed: "Listing shown / hidden",
  portal_announced: "Bookings-dashboard announcement",
  tenant_events_announced: "Tenant events announcement",
  deposit_reminder_sent: "Deposit reminder sent",
  payment_reminder_sent: "Payment reminder sent",
  upcoming_reminder_sent: "Upcoming-events reminder sent",
  rescheduled: "Date changed",
  reschedule_sent: "Date-change confirmation sent",
  reschedule_link_sent: "Change-date link sent",
